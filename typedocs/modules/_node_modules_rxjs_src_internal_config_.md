[Moment Holiday (by Nesto)](../README.md) > ["node_modules/rxjs/src/internal/config"](../modules/_node_modules_rxjs_src_internal_config_.md)

# External module: "node_modules/rxjs/src/internal/config"

## Index

### Variables

* [_enable_super_gross_mode_that_will_cause_bad_things](_node_modules_rxjs_src_internal_config_.md#_enable_super_gross_mode_that_will_cause_bad_things)

### Object literals

* [config](_node_modules_rxjs_src_internal_config_.md#config)
...
*Defined in node_modules/rxjs/src/internal/config.ts:1*
...
*Defined in node_modules/rxjs/src/internal/config.ts:7*
...
*Defined in node_modules/rxjs/src/internal/config.ts:12*

The promise constructor used by default for methods such as [toPromise](../classes/_node_modules_rxjs_src_internal_subject_.subject.md#topromise) and [forEach](../classes/_node_modules__nesto_software_moment_holiday_core_src_holiday_array_.holidayarray.md#foreach)
...
*Defined in node_modules/rxjs/src/internal/config.ts:32*
...
*Defined in node_modules/rxjs/src/internal/config.ts:22*
