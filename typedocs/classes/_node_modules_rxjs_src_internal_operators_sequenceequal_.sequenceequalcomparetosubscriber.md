[Moment Holiday (by Nesto)](../README.md) > ["node_modules/rxjs/src/internal/operators/sequenceEqual"](../modules/_node_modules_rxjs_src_internal_operators_sequenceequal_.md) > [SequenceEqualCompareToSubscriber](../classes/_node_modules_rxjs_src_internal_operators_sequenceequal_.sequenceequalcomparetosubscriber.md)
...
* [constructor](_node_modules_rxjs_src_internal_operators_sequenceequal_.sequenceequalcomparetosubscriber.md#constructor)

### Properties

* [closed](_node_modules_rxjs_src_internal_operators_sequenceequal_.sequenceequalcomparetosubscriber.md#closed)
* [syncErrorThrowable](_node_modules_rxjs_src_internal_operators_sequenceequal_.sequenceequalcomparetosubscriber.md#syncerrorthrowable)
* [syncErrorThrown](_node_modules_rxjs_src_internal_operators_sequenceequal_.sequenceequalcomparetosubscriber.md#syncerrorthrown)
* [syncErrorValue](_node_modules_rxjs_src_internal_operators_sequenceequal_.sequenceequalcomparetosubscriber.md#syncerrorvalue)
* [EMPTY](_node_modules_rxjs_src_internal_operators_sequenceequal_.sequenceequalcomparetosubscriber.md#empty)

### Methods

* [__computed](_node_modules_rxjs_src_internal_operators_sequenceequal_.sequenceequalcomparetosubscriber.md#__computed)
* [_unsubscribeAndRecycle](_node_modules_rxjs_src_internal_operators_sequenceequal_.sequenceequalcomparetosubscriber.md#_unsubscribeandrecycle)
* [add](_node_modules_rxjs_src_internal_operators_sequenceequal_.sequenceequalcomparetosubscriber.md#add)
* [complete](_node_modules_rxjs_src_internal_operators_sequenceequal_.sequenceequalcomparetosubscriber.md#complete)
* [error](_node_modules_rxjs_src_internal_operators_sequenceequal_.sequenceequalcomparetosubscriber.md#error)
* [next](_node_modules_rxjs_src_internal_operators_sequenceequal_.sequenceequalcomparetosubscriber.md#next)
* [remove](_node_modules_rxjs_src_internal_operators_sequenceequal_.sequenceequalcomparetosubscriber.md#remove)
* [unsubscribe](_node_modules_rxjs_src_internal_operators_sequenceequal_.sequenceequalcomparetosubscriber.md#unsubscribe)
* [create](_node_modules_rxjs_src_internal_operators_sequenceequal_.sequenceequalcomparetosubscriber.md#create)
...
⊕ **new SequenceEqualCompareToSubscriber**(destination: *[Observer](../interfaces/_node_modules_rxjs_src_internal_types_.observer.md)<`R`>*, parent: *`SequenceEqualSubscriber`<`T`, `R`>*): [SequenceEqualCompareToSubscriber](_node_modules_rxjs_src_internal_operators_sequenceequal_.sequenceequalcomparetosubscriber.md)
...
*Defined in node_modules/rxjs/src/internal/operators/sequenceEqual.ts:158*

**Parameters:**

| Param | Type |
| ------ | ------ |
| destination | [Observer](../interfaces/_node_modules_rxjs_src_internal_types_.observer.md)<`R`> |
| parent | `SequenceEqualSubscriber`<`T`, `R`> |

**Returns:** [SequenceEqualCompareToSubscriber](_node_modules_rxjs_src_internal_operators_sequenceequal_.sequenceequalcomparetosubscriber.md)
